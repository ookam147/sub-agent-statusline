...
`@ookam147/opencode-subagent-statusline` is installed as an OpenCode TUI plugin. Once active, it adds a subagent section to the sidebar and a compact summary on the home screen when there is activity.
